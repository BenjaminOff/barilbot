...
client.on('message', message => {
    ...
    if(message.content === prefix + "help"){
        ...
        .addField("<:hypnose:1057033340567441458> Commande<:hypnose:1057033340567441458>  ", " **```Certaine commande comme : $help,Bonjour ,$info , $statistiques $modération **```")
        
        .addField("<:hypnose:1057033340567441458>Commande fun<:hypnose:1057033340567441458> ", "**```$baril,$vcs,$userinfo,$id,$version,$say,$cv,$cvc,$server,$flipoff,$dice,$couleur,$avatar,$partenaire,$invite,$manock,$Hunter,$nice,$testbot,$energi,$staff,$blacklist,$money,$daily,$quiz,$bvn,$aurevoir,$ping,$yesman,$ranks,$rank```")
...
if(message.content === prefix + "dice"){
    ...
    let embed = new Discord.RichEmbed()
      ...
      if (message.content.startsWith(prefix + "vcs" ))
      {
          ...
          let xo3 = xoargs.join(" ")
          var xo2 = message.guild.channels.find(ch => ch.name === "barilbot")
          if (!xo2) return message.reply("le channel `vcs-barilbot` et introuvable <:refuser:430431447073947648>")
          if (message.channel.name != 'barilbot') return message.reply("la commande marche sur le channel`vcs-barilbot`<a:th:529949415306428434> ")
          ...
          client.channels.findAll('name', 'barilbot').map(channel => channel.send(IS_embed))
      }
